    ...
    <div className='w-full p-4'>
      ...
      <section className="mb-20 text-gray-700">
        <div className="text-center md:max-w-xl lg:max-w-3xl mx-auto">
          <h3 className="text-3xl font-bold mb-6 text-gray-800 uppercase ">Testimonials !</h3>
          <p className="mb-6 p-2 md:mb-12  uppercase text-orange-600 font-semibold text-xl border-l-4 border-r-4 border-orange-600">
            These Dozens of Clients Can't be Mistaken
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-12 text-center">
          <div className="mb-12 md:mb-0">
            ...
            <h6 className="font-semibold text-orange-600 mb-4">USA</h6>
            <p className="mb-4">
              <svg
                aria-hidden="true"
                focusable="false"
